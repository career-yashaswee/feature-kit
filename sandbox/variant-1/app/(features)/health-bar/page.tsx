...
export default function HealthBarPage() {
  ...
  const propMap: Record<string, keyof HealthBarProps> = {
    showTimer: "showTimer",
    ...
    <div className="min-h-screen bg-linear-to-br from-background via-background to-muted/20">
      <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-12 p-8">
        ...
        <PropsApiCard
          ...
          description="Interact with the table below to customize the component in real-time. Note: The `data` prop (HealthBarData object) is complex and not editable here."
        />
